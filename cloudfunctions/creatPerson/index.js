...
var synDetectFace = function (url, personName, personId) { //人脸识别API
  ...
  let params = '{"GroupId":"17865196312","Url":"' + url + '","PersonName":"' + personName + '","PersonId":"' + personId + '"}'
...
exports.main = async (event, context) => {
  ...
  datas = await synDetectFace(url, data.personName, data.personId) //调用异步函数，向腾讯云API发起请求
  return datas
}
